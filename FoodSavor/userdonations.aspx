<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="userdonations.aspx.cs" Inherits="FoodSavor.userdonations" %>
			...
			<div class="container request">
				...
				<div class="row padding">
					...
					<div class="col-sm-6" style="text-align: right">
						<asp:Button CssClass="btn btn-lg btn-success" ID="request_delete" runat="server" Text="Delete" CommandName="delete" />
					</div>
				</div>
			</div>
		</ItemTemplate>
